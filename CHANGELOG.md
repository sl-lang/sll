...
- Implemented `sll_api_error_get_backtrace`, `error.sll`, `error$error_type`, `error$peek`, `error$pop` and `error$push` ([#196])
...
[0.7.5]: https://github.com/sl-lang/sll/compare/sll-v0.7.4...main
