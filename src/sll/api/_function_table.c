...
void sll_api_array_count(void);
void sll_api_array_create(void);
void sll_api_array_extend(void);
void sll_api_array_index(void);
void sll_api_array_join(void);
void sll_api_array_pop(void);
void sll_api_array_push(void);
void sll_api_array_remove(void);
void sll_api_array_replace(void);
void sll_api_array_reverse(void);
void sll_api_array_shift(void);
void sll_api_array_split(void);
void sll_api_array_unshift(void);
void sll_api_atexit_register(void);
void sll_api_atexit_unregister(void);
void sll_api_audit__init(void);
void sll_api_audit_audit(void);
void sll_api_base64_decode(void);
void sll_api_base64_encode(void);
void sll_api_date_get_time_zone(void);
void sll_api_date_merge(void);
void sll_api_date_split(void);
void sll_api_error_get_call_stack(void);
void sll_api_file_close(void);
void sll_api_file_copy(void);
void sll_api_file_delete(void);
void sll_api_file_flush(void);
void sll_api_file_from_data(void);
void sll_api_file_get_buffer(void);
void sll_api_file_get_temp_path(void);
void sll_api_file_inc_handle(void);
void sll_api_file_open(void);
void sll_api_file_peek(void);
void sll_api_file_read(void);
void sll_api_file_read_char(void);
void sll_api_file_rename(void);
void sll_api_file_std_handle(void);
void sll_api_file_write(void);
void sll_api_float_get_compare_error(void);
void sll_api_float_set_compare_error(void);
void sll_api_hash_md5(void);
void sll_api_hash_sha1(void);
void sll_api_hash_sha256(void);
void sll_api_hash_sha512(void);
void sll_api_int_to_bin(void);
void sll_api_int_to_dec(void);
void sll_api_int_to_hex(void);
void sll_api_int_to_oct(void);
void sll_api_json__init(void);
void sll_api_json_parse(void);
void sll_api_json_stringify(void);
void sll_api_log_log(void);
void sll_api_log_set_default(void);
void sll_api_log_set_file(void);
void sll_api_log_set_function(void);
void sll_api_map_extend(void);
void sll_api_map_remove(void);
void sll_api_math_abs(void);
void sll_api_math_acos(void);
void sll_api_math_acosh(void);
void sll_api_math_asin(void);
void sll_api_math_asinh(void);
void sll_api_math_atan(void);
void sll_api_math_atan2(void);
void sll_api_math_atanh(void);
void sll_api_math_cbrt(void);
void sll_api_math_combinations(void);
void sll_api_math_cos(void);
void sll_api_math_cosh(void);
void sll_api_math_ceil(void);
void sll_api_math_copy_sign(void);
void sll_api_math_euler_phi(void);
void sll_api_math_exp(void);
void sll_api_math_factorial(void);
void sll_api_math_factors(void);
void sll_api_math_gcd(void);
void sll_api_math_floor(void);
void sll_api_math_int_log2(void);
void sll_api_math_int_pow(void);
void sll_api_math_int_sqrt(void);
void sll_api_math_log(void);
void sll_api_math_log2(void);
void sll_api_math_log10(void);
void sll_api_math_permutations(void);
void sll_api_math_pow(void);
void sll_api_math_round(void);
void sll_api_math_sin(void);
void sll_api_math_sinh(void);
void sll_api_math_sqrt(void);
void sll_api_math_tan(void);
void sll_api_math_tanh(void);
void sll_api_object_new(void);
void sll_api_path_absolute(void);
void sll_api_path_exists(void);
void sll_api_path_get_cwd(void);
void sll_api_path_is_dir(void);
void sll_api_path_join(void);
void sll_api_path_list_dir(void);
void sll_api_path_mkdir(void);
void sll_api_path_recursive_list_dir(void);
void sll_api_path_relative(void);
void sll_api_path_set_cwd(void);
void sll_api_path_size(void);
void sll_api_path_split(void);
void sll_api_path_split_drive(void);
void sll_api_process_execute_shell(void);
void sll_api_process_get_pid(void);
void sll_api_process_join(void);
void sll_api_process_split(void);
void sll_api_process_start(void);
void sll_api_random_get_float(void);
void sll_api_random_get_int(void);
void sll_api_random_get_string(void);
void sll_api_serial_decode_float(void);
void sll_api_serial_decode_integer(void);
void sll_api_serial_decode_signed_integer(void);
void sll_api_serial_decode_object(void);
void sll_api_serial_decode_string(void);
void sll_api_serial_encode_float(void);
void sll_api_serial_encode_integer(void);
void sll_api_serial_encode_signed_integer(void);
void sll_api_serial_encode_object(void);
void sll_api_serial_encode_string(void);
void sll_api_sort_quicksort(void);
void sll_api_string_checksum(void);
void sll_api_string_convert(void);
void sll_api_string_count(void);
void sll_api_string_count_left(void);
void sll_api_string_count_right(void);
void sll_api_string_ends(void);
void sll_api_string_format(void);
void sll_api_string_flip_case(void);
void sll_api_string_index(void);
void sll_api_string_index_list(void);
void sll_api_string_index_reverse(void);
void sll_api_string_index_reverse_list(void);
void sll_api_string_join(void);
void sll_api_string_pad(void);
void sll_api_string_pad_left(void);
void sll_api_string_pad_right(void);
void sll_api_string_replace(void);
void sll_api_string_reverse(void);
void sll_api_string_secure_equal(void);
void sll_api_string_split(void);
void sll_api_string_starts(void);
void sll_api_string_to_lower_case(void);
void sll_api_string_to_title_case(void);
void sll_api_string_trim(void);
void sll_api_string_trim_left(void);
void sll_api_string_trim_right(void);
void sll_api_string_to_upper_case(void);
void sll_api_struct_float_from_bits(void);
void sll_api_struct_double_from_bits(void);
void sll_api_struct_float_to_bits(void);
void sll_api_struct_double_to_bits(void);
void sll_api_sys_get_args(void);
void sll_api_sys_get_cpu_count(void);
void sll_api_sys_get_env(void);
void sll_api_sys_get_executable(void);
void sll_api_sys_get_library(void);
void sll_api_sys_get_platform(void);
void sll_api_sys_get_sandbox_flags(void);
void sll_api_sys_get_version(void);
void sll_api_sys_load_library(void);
void sll_api_sys_remove_env(void);
void sll_api_sys_set_sandbox_flag(void);
void sll_api_sys_set_env(void);
void sll_api_thread_create(void);
void sll_api_thread_create_barrier(void);
void sll_api_thread_create_lock(void);
void sll_api_thread_create_semaphore(void);
void sll_api_thread_delete(void);
void sll_api_thread_delete_barrier(void);
void sll_api_thread_delete_lock(void);
void sll_api_thread_delete_semaphore(void);
void sll_api_thread_get_internal_data(void);
void sll_api_thread_increase_barrier(void);
void sll_api_thread_release_lock(void);
void sll_api_thread_release_semaphore(void);
void sll_api_thread_reset_barrier(void);
void sll_api_thread_restart(void);
void sll_api_thread_suspend(void);
void sll_api_time_current(void);
void sll_api_time_current_ns(void);
void sll_api_time_sleep(void);
void sll_api_time_sleep_ns(void);
void sll_api_vm_get_config(void);
void sll_api_vm_get_instruction_count(void);
void sll_api_vm_get_instruction_index(void);
void sll_api_vm_get_location(void);
void sll_api_vm_get_ref_count(void);
void sll_api_weakref__init(void);
void sll_api_weakref_create(void);
void sll_api_weakref_delete(void);
void sll_api_weakref_get(void);
void sll_api_weakref_set_callback_data(void);
