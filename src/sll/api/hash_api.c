...
__API_FUNC(hash_sha512){
	...
	for (sll_string_length_t idx=0;idx<(i->l>>7);idx++){
		...
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[3]+0xe9b5dba58189dbbcull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[4]+0x3956c25bf348b538ull);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[5]+0x59f111f1b605d019ull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[6]+0x923f82a4af194f9bull);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[7]+0xab1c5ed5da6d8118ull);
		SHA512_STEP(da,db,dc,dd,de,df,dg,dh,w[8]+0xd807aa98a3030242ull);
		SHA512_STEP(dh,da,db,dc,dd,de,df,dg,w[9]+0x12835b0145706fbeull);
		SHA512_STEP(dg,dh,da,db,dc,dd,de,df,w[10]+0x243185be4ee4b28cull);
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[11]+0x550c7dc3d5ffb4e2ull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[12]+0x72be5d74f27b896full);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[13]+0x80deb1fe3b1696b1ull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[14]+0x9bdc06a725c71235ull);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[15]+0xc19bf174cf692694ull);
		SHA512_STEP(da,db,dc,dd,de,df,dg,dh,w[16]+0xe49b69c19ef14ad2ull);
		SHA512_STEP(dh,da,db,dc,dd,de,df,dg,w[17]+0xefbe4786384f25e3ull);
		SHA512_STEP(dg,dh,da,db,dc,dd,de,df,w[18]+0x0fc19dc68b8cd5b5ull);
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[19]+0x240ca1cc77ac9c65ull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[20]+0x2de92c6f592b0275ull);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[21]+0x4a7484aa6ea6e483ull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[22]+0x5cb0a9dcbd41fbd4ull);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[23]+0x76f988da831153b5ull);
		SHA512_STEP(da,db,dc,dd,de,df,dg,dh,w[24]+0x983e5152ee66dfabull);
		SHA512_STEP(dh,da,db,dc,dd,de,df,dg,w[25]+0xa831c66d2db43210ull);
		SHA512_STEP(dg,dh,da,db,dc,dd,de,df,w[26]+0xb00327c898fb213full);
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[27]+0xbf597fc7beef0ee4ull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[28]+0xc6e00bf33da88fc2ull);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[29]+0xd5a79147930aa725ull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[30]+0x06ca6351e003826full);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[31]+0x142929670a0e6e70ull);
		SHA512_STEP(da,db,dc,dd,de,df,dg,dh,w[32]+0x27b70a8546d22ffcull);
		SHA512_STEP(dh,da,db,dc,dd,de,df,dg,w[33]+0x2e1b21385c26c926ull);
		SHA512_STEP(dg,dh,da,db,dc,dd,de,df,w[34]+0x4d2c6dfc5ac42aedull);
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[35]+0x53380d139d95b3dfull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[36]+0x650a73548baf63deull);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[37]+0x766a0abb3c77b2a8ull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[38]+0x81c2c92e47edaee6ull);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[39]+0x92722c851482353bull);
		SHA512_STEP(da,db,dc,dd,de,df,dg,dh,w[40]+0xa2bfe8a14cf10364ull);
		SHA512_STEP(dh,da,db,dc,dd,de,df,dg,w[41]+0xa81a664bbc423001ull);
		SHA512_STEP(dg,dh,da,db,dc,dd,de,df,w[42]+0xc24b8b70d0f89791ull);
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[43]+0xc76c51a30654be30ull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[44]+0xd192e819d6ef5218ull);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[45]+0xd69906245565a910ull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[46]+0xf40e35855771202aull);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[47]+0x106aa07032bbd1b8ull);
		SHA512_STEP(da,db,dc,dd,de,df,dg,dh,w[48]+0x19a4c116b8d2d0c8ull);
		SHA512_STEP(dh,da,db,dc,dd,de,df,dg,w[49]+0x1e376c085141ab53ull);
		SHA512_STEP(dg,dh,da,db,dc,dd,de,df,w[50]+0x2748774cdf8eeb99ull);
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[51]+0x34b0bcb5e19b48a8ull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[52]+0x391c0cb3c5c95a63ull);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[53]+0x4ed8aa4ae3418acbull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[54]+0x5b9cca4f7763e373ull);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[55]+0x682e6ff3d6b2b8a3ull);
		SHA512_STEP(da,db,dc,dd,de,df,dg,dh,w[56]+0x748f82ee5defb2fcull);
		SHA512_STEP(dh,da,db,dc,dd,de,df,dg,w[57]+0x78a5636f43172f60ull);
		SHA512_STEP(dg,dh,da,db,dc,dd,de,df,w[58]+0x84c87814a1f0ab72ull);
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[59]+0x8cc702081a6439ecull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[60]+0x90befffa23631e28ull);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[61]+0xa4506cebde82bde9ull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[62]+0xbef9a3f7b2c67915ull);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[63]+0xc67178f2e372532bull);
		SHA512_STEP(da,db,dc,dd,de,df,dg,dh,w[64]+0xca273eceea26619cull);
		SHA512_STEP(dh,da,db,dc,dd,de,df,dg,w[65]+0xd186b8c721c0c207ull);
		SHA512_STEP(dg,dh,da,db,dc,dd,de,df,w[66]+0xeada7dd6cde0eb1eull);
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[67]+0xf57d4f7fee6ed178ull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[68]+0x06f067aa72176fbaull);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[69]+0x0a637dc5a2c898a6ull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[70]+0x113f9804bef90daeull);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[71]+0x1b710b35131c471bull);
		SHA512_STEP(da,db,dc,dd,de,df,dg,dh,w[72]+0x28db77f523047d84ull);
		SHA512_STEP(dh,da,db,dc,dd,de,df,dg,w[73]+0x32caab7b40c72493ull);
		SHA512_STEP(dg,dh,da,db,dc,dd,de,df,w[74]+0x3c9ebe0a15c9bebcull);
		SHA512_STEP(df,dg,dh,da,db,dc,dd,de,w[75]+0x431d67c49c100d4cull);
		SHA512_STEP(de,df,dg,dh,da,db,dc,dd,w[76]+0x4cc5d4becb3e42b6ull);
		SHA512_STEP(dd,de,df,dg,dh,da,db,dc,w[77]+0x597f299cfc657e2aull);
		SHA512_STEP(dc,dd,de,df,dg,dh,da,db,w[78]+0x5fcb6fab3ad6faecull);
		SHA512_STEP(db,dc,dd,de,df,dg,dh,da,w[79]+0x6c44198c4a475817ull);
		av+=da;
		bv+=db;
		cv+=dc;
		dv+=dd;
