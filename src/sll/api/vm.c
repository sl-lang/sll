...
__API_FUNC_DECL(vm_get_config){
	...
	out->v[0]=SLL_FROM_INT(sll_current_vm_config->s_sz);
	out->v[1]=SLL_FROM_INT(sll_current_vm_config->c_st_sz);
	out->v[2]=SLL_FROM_INT(sll_file_to_handle(sll_current_vm_config->in));
	out->v[3]=SLL_FROM_INT(sll_file_to_handle(sll_current_vm_config->out));
	out->v[4]=SLL_FROM_INT(sll_file_to_handle(sll_current_vm_config->err));
}
