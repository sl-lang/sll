...
static const internal_function_t _ifunc_data_ptr[]={
	...
	{"file_read",sll_api_file_read_raw,SLL_INTERNAL_FUNCTION_FLAG_REQUIRED},
	...
	{"string_flip_case",sll_api_string_flip_case_raw,SLL_INTERNAL_FUNCTION_FLAG_COMPILATION_CALL},
