...
#define COMBINED_CAST_TYPE_II COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_INT,SLL_RUNTIME_OBJECT_TYPE_INT)
#define COMBINED_CAST_TYPE_IF COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_INT,SLL_RUNTIME_OBJECT_TYPE_FLOAT)
#define COMBINED_CAST_TYPE_IC COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_INT,SLL_RUNTIME_OBJECT_TYPE_CHAR)
#define COMBINED_CAST_TYPE_IS COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_INT,SLL_RUNTIME_OBJECT_TYPE_STRING)
#define COMBINED_CAST_TYPE_IA COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_INT,SLL_RUNTIME_OBJECT_TYPE_ARRAY)
#define COMBINED_CAST_TYPE_IH COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_INT,SLL_RUNTIME_OBJECT_TYPE_HANDLE)
#define COMBINED_CAST_TYPE_IM COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_INT,SLL_RUNTIME_OBJECT_TYPE_MAP)
#define COMBINED_CAST_TYPE_IK COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_INT,SLL_RUNTIME_OBJECT_TYPE_MAP_KEYS)
#define COMBINED_CAST_TYPE_IV COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_INT,SLL_RUNTIME_OBJECT_TYPE_MAP_VALUES)
#define COMBINED_CAST_TYPE_FI COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_FLOAT,SLL_RUNTIME_OBJECT_TYPE_INT)
#define COMBINED_CAST_TYPE_FF COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_FLOAT,SLL_RUNTIME_OBJECT_TYPE_FLOAT)
#define COMBINED_CAST_TYPE_FC COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_FLOAT,SLL_RUNTIME_OBJECT_TYPE_CHAR)
#define COMBINED_CAST_TYPE_FS COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_FLOAT,SLL_RUNTIME_OBJECT_TYPE_STRING)
#define COMBINED_CAST_TYPE_FA COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_FLOAT,SLL_RUNTIME_OBJECT_TYPE_ARRAY)
#define COMBINED_CAST_TYPE_FH COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_FLOAT,SLL_RUNTIME_OBJECT_TYPE_HANDLE)
#define COMBINED_CAST_TYPE_FM COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_FLOAT,SLL_RUNTIME_OBJECT_TYPE_MAP)
#define COMBINED_CAST_TYPE_FK COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_FLOAT,SLL_RUNTIME_OBJECT_TYPE_MAP_KEYS)
#define COMBINED_CAST_TYPE_FV COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_FLOAT,SLL_RUNTIME_OBJECT_TYPE_MAP_VALUES)
#define COMBINED_CAST_TYPE_CI COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_CHAR,SLL_RUNTIME_OBJECT_TYPE_INT)
#define COMBINED_CAST_TYPE_CF COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_CHAR,SLL_RUNTIME_OBJECT_TYPE_FLOAT)
#define COMBINED_CAST_TYPE_CC COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_CHAR,SLL_RUNTIME_OBJECT_TYPE_CHAR)
#define COMBINED_CAST_TYPE_CS COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_CHAR,SLL_RUNTIME_OBJECT_TYPE_STRING)
#define COMBINED_CAST_TYPE_CA COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_CHAR,SLL_RUNTIME_OBJECT_TYPE_ARRAY)
#define COMBINED_CAST_TYPE_CH COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_CHAR,SLL_RUNTIME_OBJECT_TYPE_HANDLE)
#define COMBINED_CAST_TYPE_CM COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_CHAR,SLL_RUNTIME_OBJECT_TYPE_MAP)
#define COMBINED_CAST_TYPE_CK COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_CHAR,SLL_RUNTIME_OBJECT_TYPE_MAP_KEYS)
#define COMBINED_CAST_TYPE_CV COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_CHAR,SLL_RUNTIME_OBJECT_TYPE_MAP_VALUES)
#define COMBINED_CAST_TYPE_SI COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_STRING,SLL_RUNTIME_OBJECT_TYPE_INT)
#define COMBINED_CAST_TYPE_SF COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_STRING,SLL_RUNTIME_OBJECT_TYPE_FLOAT)
#define COMBINED_CAST_TYPE_SC COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_STRING,SLL_RUNTIME_OBJECT_TYPE_CHAR)
#define COMBINED_CAST_TYPE_SS COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_STRING,SLL_RUNTIME_OBJECT_TYPE_STRING)
#define COMBINED_CAST_TYPE_SA COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_STRING,SLL_RUNTIME_OBJECT_TYPE_ARRAY)
#define COMBINED_CAST_TYPE_SH COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_STRING,SLL_RUNTIME_OBJECT_TYPE_HANDLE)
#define COMBINED_CAST_TYPE_SM COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_STRING,SLL_RUNTIME_OBJECT_TYPE_MAP)
#define COMBINED_CAST_TYPE_SK COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_STRING,SLL_RUNTIME_OBJECT_TYPE_MAP_KEYS)
#define COMBINED_CAST_TYPE_SV COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_STRING,SLL_RUNTIME_OBJECT_TYPE_MAP_VALUES)
#define COMBINED_CAST_TYPE_AI COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_ARRAY,SLL_RUNTIME_OBJECT_TYPE_INT)
#define COMBINED_CAST_TYPE_AF COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_ARRAY,SLL_RUNTIME_OBJECT_TYPE_FLOAT)
#define COMBINED_CAST_TYPE_AC COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_ARRAY,SLL_RUNTIME_OBJECT_TYPE_CHAR)
#define COMBINED_CAST_TYPE_AS COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_ARRAY,SLL_RUNTIME_OBJECT_TYPE_STRING)
#define COMBINED_CAST_TYPE_AA COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_ARRAY,SLL_RUNTIME_OBJECT_TYPE_ARRAY)
#define COMBINED_CAST_TYPE_AH COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_ARRAY,SLL_RUNTIME_OBJECT_TYPE_HANDLE)
#define COMBINED_CAST_TYPE_AM COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_ARRAY,SLL_RUNTIME_OBJECT_TYPE_MAP)
#define COMBINED_CAST_TYPE_AK COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_ARRAY,SLL_RUNTIME_OBJECT_TYPE_MAP_KEYS)
#define COMBINED_CAST_TYPE_AV COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_ARRAY,SLL_RUNTIME_OBJECT_TYPE_MAP_VALUES)
#define COMBINED_CAST_TYPE_HI COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_HANDLE,SLL_RUNTIME_OBJECT_TYPE_INT)
#define COMBINED_CAST_TYPE_HF COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_HANDLE,SLL_RUNTIME_OBJECT_TYPE_FLOAT)
#define COMBINED_CAST_TYPE_HC COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_HANDLE,SLL_RUNTIME_OBJECT_TYPE_CHAR)
#define COMBINED_CAST_TYPE_HS COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_HANDLE,SLL_RUNTIME_OBJECT_TYPE_STRING)
#define COMBINED_CAST_TYPE_HA COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_HANDLE,SLL_RUNTIME_OBJECT_TYPE_ARRAY)
#define COMBINED_CAST_TYPE_HH COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_HANDLE,SLL_RUNTIME_OBJECT_TYPE_HANDLE)
#define COMBINED_CAST_TYPE_HM COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_HANDLE,SLL_RUNTIME_OBJECT_TYPE_MAP)
#define COMBINED_CAST_TYPE_HK COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_HANDLE,SLL_RUNTIME_OBJECT_TYPE_MAP_KEYS)
#define COMBINED_CAST_TYPE_HV COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_HANDLE,SLL_RUNTIME_OBJECT_TYPE_MAP_VALUES)
#define COMBINED_CAST_TYPE_MI COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_MAP,SLL_RUNTIME_OBJECT_TYPE_INT)
#define COMBINED_CAST_TYPE_MF COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_MAP,SLL_RUNTIME_OBJECT_TYPE_FLOAT)
#define COMBINED_CAST_TYPE_MC COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_MAP,SLL_RUNTIME_OBJECT_TYPE_CHAR)
#define COMBINED_CAST_TYPE_MS COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_MAP,SLL_RUNTIME_OBJECT_TYPE_STRING)
#define COMBINED_CAST_TYPE_MA COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_MAP,SLL_RUNTIME_OBJECT_TYPE_ARRAY)
#define COMBINED_CAST_TYPE_MH COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_MAP,SLL_RUNTIME_OBJECT_TYPE_HANDLE)
#define COMBINED_CAST_TYPE_MM COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_MAP,SLL_RUNTIME_OBJECT_TYPE_MAP)
#define COMBINED_CAST_TYPE_MK COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_MAP,SLL_RUNTIME_OBJECT_TYPE_MAP_KEYS)
#define COMBINED_CAST_TYPE_MV COMBINE_CAST_TYPES(SLL_RUNTIME_OBJECT_TYPE_MAP,SLL_RUNTIME_OBJECT_TYPE_MAP_VALUES)
...
__SLL_EXTERNAL __SLL_CHECK_OUTPUT sll_runtime_object_t* sll_operator_access_range_step(sll_runtime_object_t* a,sll_runtime_object_t* b,sll_runtime_object_t* c,sll_runtime_object_t* d){
	if (SLL_RUNTIME_OBJECT_GET_TYPE(a)==SLL_RUNTIME_OBJECT_TYPE_STRING){
		...
		sll_runtime_object_t* o=SLL_CREATE();
		o->t=SLL_RUNTIME_OBJECT_TYPE_MAP;
		sll_runtime_object_t* l[3]={b,c,d};
		sll_array_t arr={
			3,
			l
		};
...
__SLL_EXTERNAL void sll_operator_assign(sll_runtime_object_t* a,sll_runtime_object_t* b,sll_runtime_object_t* v){
	if (SLL_RUNTIME_OBJECT_GET_TYPE(a)==SLL_RUNTIME_OBJECT_TYPE_STRING){
		if (SLL_RUNTIME_OBJECT_GET_TYPE(b)==SLL_RUNTIME_OBJECT_TYPE_INT&&b->dt.i>=0&&b->dt.i<a->dt.s.l){
			sll_runtime_object_t* tmp=sll_operator_cast(v,sll_static_int[SLL_RUNTIME_OBJECT_TYPE_CHAR]);
