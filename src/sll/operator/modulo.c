		...
		case COMBINED_TYPE_FS:
			{
				...
				for (sll_string_length_t i=0;i<b->data.string.length;i++){
					o->data.array.data[i]=sll_operator_mod(a,sll_static_char[b->data.string.data[i]]);
				}
				return o;
			}
		...
		case COMBINED_TYPE_SF:
			{
				...
				for (sll_string_length_t i=0;i<a->data.string.length;i++){
					o->data.array.data[i]=sll_operator_mod(sll_static_char[a->data.string.data[i]],b);
				}
				return o;
			}
