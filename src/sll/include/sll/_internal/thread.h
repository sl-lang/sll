...
#define THREAD_SIZE SLL_ROUND_PAGE(sizeof(thread_data_t)+sll_current_vm_config->c_st_sz*sizeof(sll_call_stack_frame_t)+(sll_current_vm_config->s_sz+sll_current_runtime_data->assembly_data->tls_variable_count)*sizeof(sll_object_t*))
