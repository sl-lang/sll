...
#define SLL_ERROR_UNEXPECTED_CHARACTER 14
#define SLL_ERROR_UNKNOWN_IDENTIFIER 15
#define SLL_ERROR_INVALID_FILE_FORMAT 16
#define SLL_ERROR_INVALID_INSTRUCTION 17
#define SLL_ERROR_INVALID_INSTRUCTION_INDEX 18
