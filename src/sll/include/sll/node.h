...
#define SLL_NODE_TYPE_CAST 51
#define SLL_NODE_TYPE_TYPEOF 52
#define SLL_NODE_TYPE_DECL 53
#define SLL_NODE_TYPE_DECL_COPY 54
#define SLL_NODE_TYPE_NEW 55
#define SLL_NODE_TYPE_BREAK 56
#define SLL_NODE_TYPE_CONTINUE 57
#define SLL_NODE_TYPE_REF 58
#define SLL_NODE_TYPE_RETURN 59
#define SLL_NODE_TYPE_EXIT 60
#define SLL_NODE_TYPE_COMMA 61
#define SLL_NODE_TYPE_OPERATION_LIST 62
#define SLL_NODE_TYPE_DBG 63
 ...
 * \ret sll_bool_t
 */
__SLL_EXTERNAL __SLL_CHECK_OUTPUT sll_bool_t sll_parse_all_nodes(sll_compilation_data_t* c_dt,sll_internal_function_table_t* i_ft,sll_import_resolver_t il);
