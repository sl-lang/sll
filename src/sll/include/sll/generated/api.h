...
/**
 * \flags check_output func
 * \name sll_api_date_get_time_zone_raw
 * \group raw-api
 * \subgroup raw-api-date-api
 * \desc Wrapper function for :sll_api_date_get_time_zone:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
...
/**
 * \flags check_output func
 * \name sll_api_file_delete_raw
 * \group raw-api
 * \subgroup raw-api-file-api
 * \desc Wrapper function for :sll_api_file_delete:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-file-api
 * \desc Wrapper function for :sll_api_file_from_data:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-file-api
 * \desc Wrapper function for :sll_api_file_get_buffer:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-file-api
 * \desc Wrapper function for :sll_api_file_inc_handle:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-file-api
 * \desc Wrapper function for :sll_api_file_peek:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-hash-api
 * \desc Wrapper function for :sll_api_hash_sha256:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
...
#define __SLL_API_ARGS_sll_api_log_log sll_object_t** a,sll_arg_count_t ac
/**
 * \flags func
 * \name sll_api_log_log
 * \group log-api
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_acos:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_acosh:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_asin:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_asinh:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_atan:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_atan2:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_atanh:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_cbrt:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_cos:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_cosh:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_int_log2:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_int_pow:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_int_sqrt:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_log:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_log2:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_pow:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_sin:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_sinh:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_sqrt:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_tan:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-math-api
 * \desc Wrapper function for :sll_api_math_tanh:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
...
#define __SLL_API_ARGS_sll_api_object_new sll_string_t* a,sll_object_t** b,sll_arg_count_t bc
/**
 * \flags check_output func
...
#define __SLL_API_ARGS_sll_api_serial_encode_object sll_integer_t a,sll_object_t** b,sll_arg_count_t bc
/**
 * \flags func
 ...
 * \group raw-api
 * \subgroup raw-api-string-api
 * \desc Wrapper function for :sll_api_string_count_right:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-string-api
 * \desc Wrapper function for :sll_api_string_pad:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-string-api
 * \desc Wrapper function for :sll_api_string_trim:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-string-api
 * \desc Wrapper function for :sll_api_string_trim_left:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
 ...
 * \group raw-api
 * \subgroup raw-api-string-api
 * \desc Wrapper function for :sll_api_string_trim_right:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
...
/**
 * \flags check_output func
 * \name sll_api_thread_create_semaphore_raw
 * \group raw-api
 * \subgroup raw-api-thread-api
 * \desc Wrapper function for :sll_api_thread_create_semaphore:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
...
/**
 * \flags check_output func
 * \name sll_api_thread_release_semaphore_raw
 * \group raw-api
 * \subgroup raw-api-thread-api
...
/**
 * \flags check_output func
 * \name sll_api_weakref__init_raw
 * \group raw-api
 * \subgroup raw-api-weakref-api
 * \desc Wrapper function for :sll_api_weakref__init:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
...
/**
 * \flags check_output func
 * \name sll_api_weakref_create_raw
 * \group raw-api
 * \subgroup raw-api-weakref-api
 * \desc Wrapper function for :sll_api_weakref_create:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
...
/**
 * \flags check_output func
 * \name sll_api_weakref_delete_raw
 * \group raw-api
 * \subgroup raw-api-weakref-api
 * \desc Wrapper function for :sll_api_weakref_delete:
 * \arg sll_object_t*const* al -> Arguments
 * \arg sll_arg_count_t all -> Argument count
 * \ret sll_object_t* -> The return value of the function
 */
...
#define __SLL_API_TYPE_sll_api_weakref_get __SLL_CHECK_OUTPUT sll_object_t*
#define __SLL_API_ARGS_sll_api_weakref_get sll_integer_t a
/**
 * \flags check_output func
