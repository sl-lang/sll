...
#define GFX_BUFFER_TYPE_TEXTURE 8

#define GFX_BUFFER_DATA_TYPE_UINT8 0
#define GFX_BUFFER_DATA_TYPE_UINT16 1
#define GFX_BUFFER_DATA_TYPE_FLOAT16 2
#define GFX_BUFFER_DATA_TYPE_UINT32 3
#define GFX_BUFFER_DATA_TYPE_FLOAT32 4
#define GFX_BUFFER_DATA_TYPE_UINT64 5
#define GFX_BUFFER_DATA_TYPE_FLOAT64 6
