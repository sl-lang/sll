...
#define GFX_INPUT_TYPE_FLOAT_1 0
#define GFX_INPUT_TYPE_FLOAT_2 1
#define GFX_INPUT_TYPE_FLOAT_3 2
#define GFX_INPUT_TYPE_FLOAT_4 3
#define GFX_INPUT_TYPE_UINT_1 4
#define GFX_INPUT_TYPE_UINT_2 5
#define GFX_INPUT_TYPE_UINT_3 6
#define GFX_INPUT_TYPE_UINT_4 7
#define GFX_INPUT_TYPE_SINT_1 8
#define GFX_INPUT_TYPE_SINT_2 9
#define GFX_INPUT_TYPE_SINT_3 10
#define GFX_INPUT_TYPE_SINT_4 11
