...
#define SLL_RUNTIME_OBJECT_TYPE_MAP_KEYS 7
#define SLL_RUNTIME_OBJECT_TYPE_MAP_VALUES 8
#define SLL_RUNTIME_OBJECT_TYPE_RESERVED2 62
#define SLL_RUNTIME_OBJECT_TYPE_RESERVED3 63

#define SLL_MAX_RUNTIME_OBEJCT_TYPE SLL_RUNTIME_OBJECT_TYPE_MAP_VALUES
