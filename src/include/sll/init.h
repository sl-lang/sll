...
#define SLL_INIT_COMPILATION_DATA_STRUCT {SLL_INIT_INPUT_DATA_STREAM_STRUCT,0,NULL,SLL_INIT_IDENTIFIER_TABLE_STRUCT,SLL_INIT_EXPORT_TABLE_STRUCT,SLL_INIT_FUNCTION_TABLE_STRUCT,SLL_INIT_STRING_TABLE_STRUCT,SLL_INIT_COMPILATION_STACK_DATA_STRUCT,0}
