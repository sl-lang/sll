...
#define STRING_COMPRESSION_BUFFER_OFFSET ((1<<STRING_COMPRESSION_OFFSET_BIT_COUNT)-(1<<STRING_COMPRESSION_LENGTH_BIT_COUNT)-1)
#define STRING_COMPRESSION_BUFFER_SIZE (1<<(STRING_COMPRESSION_OFFSET_BIT_COUNT+1))
