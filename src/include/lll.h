...
#ifdef _MSC_VER
#ifdef __DLL_COMPILATION__
#define LLL_IMPORT_EXPORT __declspec(dllexport)
#else
#define LLL_IMPORT_EXPORT __declspec(dllimport)
#endif
#define LLL_CHECK_OUTPUT _Check_return_
#else
#define LLL_IMPORT_EXPORT
#define LLL_CHECK_OUTPUT __attribute__((warn_unused_result))
#endif
