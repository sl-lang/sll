...
#define LLL_ERROR_NO_STACK 33
#define LLL_ERROR_STACK_TOO_BIG 34
#define LLL_ERROR_FAILED_FILE_WRITE 35
#define LLL_ERROR_DIVISION_BY_ZERO 36
#define LLL_MAX_SYNTAX_ERROR LLL_ERROR_MULTIPLE_SIZE_MODIFIERS
