...
uint8_t _output_data_stream_file_write_string(lll_output_data_stream_t* os,const char* s){
	while (*s){
		fputc(*s,(FILE*)(os->ctx));
		s++;
	}
...
uint8_t _output_data_stream_file_write(lll_output_data_stream_t* os,const uint8_t* bf,size_t sz){
